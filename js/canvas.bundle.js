...
var skillData = [{ text: "Linux", size: 14, color: "pink" }, { text: "Bash", size: 10, color: "yellow" }, { text: "Vim", size: 8, color: "chartreuse" }, { text: "Web Development", size: 9, color: "cornflowerblue" }, { text: "Adobe Ae & Ai", size: 8.5, color: "orange" }, { text: "PNMOS", size: 8, color: "red" }, { text: "Medium", size: 8, color: "deeppink" }, { text: "Go", size: 9, color: "aquamarine" }, { text: "Python", size: 8, color: "darkviolet" }];
